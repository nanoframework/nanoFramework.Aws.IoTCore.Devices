...
|:-|---|---|
| nanoFramework.Aws.IoTCore.Devices | [![Build Status](https://dev.azure.com/nanoframework/nanoFramework.Aws.IoTCore.Devices/_apis/build/status/Aws.IoTCore.Devices?repoName=nanoframework%2FnanoFramework.Aws.IoTCore.Devices&branchName=main)](https://dev.azure.com/nanoframework/nanoFramework.Aws.IoTCore.Devices/_build/latest?definitionId=81&repoName=nanoframework%2FnanoFramework.Aws.IoTCore.Devices&branchName=main) | [![NuGet](https://img.shields.io/nuget/v/nanoFramework.Aws.IoTCore.Devices.svg?label=NuGet&style=flat&logo=nuget)](https://www.nuget.org/packages/nanoFramework.Aws.IoTCore.Devices/) |
...
![edit device network](https://raw.githubusercontent.com/nanoframework/nanoFramework.Aws.IoTCore.Devices/main/readme-assets/device-network.jpg)

Navigate to the `General` tab:

![device network certificate](https://raw.githubusercontent.com/nanoframework/nanoFramework.Aws.IoTCore.Devices/main/readme-assets/device-network-certificate.jpg)
